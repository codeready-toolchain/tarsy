...
func (Message_Role) EnumDescriptor() ([]byte, []int) {
	return file_proto_llm_service_proto_rawDescGZIP(), []int{1, 0}
}
...
const file_proto_llm_service_proto_rawDesc = "" +
	"\n" +
	"\x17proto/llm_service.proto\x12\x06llm.v1\"\xdd\x01\n" +
...
func file_proto_llm_service_proto_init() {
	...
	file_proto_llm_service_proto_msgTypes[0].OneofWrappers = []any{}
	file_proto_llm_service_proto_msgTypes[2].OneofWrappers = []any{
