...
var (
	...
	TimelineEventsColumns = []*schema.Column{
		...
		{Name: "event_type", Type: field.TypeEnum, Enums: []string{"llm_thinking", "llm_response", "llm_tool_call", "mcp_tool_call", "mcp_tool_summary", "user_question", "executive_summary", "final_analysis"}},
