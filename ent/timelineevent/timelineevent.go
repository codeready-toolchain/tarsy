...
func EventTypeValidator(et EventType) error {
	switch et {
	case EventTypeLlmThinking, EventTypeLlmResponse, EventTypeLlmToolCall, EventTypeMcpToolCall, EventTypeMcpToolSummary, EventTypeUserQuestion, EventTypeExecutiveSummary, EventTypeFinalAnalysis:
		return nil
	default:
